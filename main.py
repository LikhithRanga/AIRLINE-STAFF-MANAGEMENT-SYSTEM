...
def login_register():
    st.title("AIRLINE DATABASE MANAGEMENT SYSTEM")
    st.header("Login/Register Page")
        ...
        if st.button("Login"):
            ...
            if user_data:
                ...
                if role == 'admin':
                    ...
                    st.balloons()
                    admin_page_url = "http://localhost:8503/"  # Change the port if needed
                    ...
                    employee_page_url = "http://localhost:8502/"  # Change the port if needed
